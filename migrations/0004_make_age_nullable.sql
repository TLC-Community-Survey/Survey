-- Migration to make age nullable (hardware surveys don't require age)
-- This allows hardware surveys to be submitted without age information
--
-- NOTE: D1 doesn't support BEGIN TRANSACTION/COMMIT, so this migration
-- runs statements individually. Each statement is atomic in D1.

-- Create temporary table with updated schema (age is now nullable)
...
-- This will fail gracefully if the table doesn't exist or columns don't match
